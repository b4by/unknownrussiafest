...
export interface ApiMovieMovie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    screenwriter: Attribute.String;
    poster: Attribute.Media;
    screenshots: Attribute.Media;
    trailer_link: Attribute.String;
    production: Attribute.String;
    description: Attribute.RichText;
    slug: Attribute.UID<'api::movie.movie', 'title'>;
    director_photo: Attribute.Media;
    ...
    photography: Attribute.String;
    tickets_available: Attribute.Integer & Attribute.DefaultTo<55>;
    visitors: Attribute.Relation<
      'api::movie.movie',
      'oneToMany',
      'api::visitor.visitor'
    > &
...
export interface ApiVisitorVisitor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    passport_number: Attribute.String;
    passport_issued_by: Attribute.String;
    passport_date_issued: Attribute.Date;
    movie: Attribute.Relation<
      'api::visitor.visitor',
      'manyToOne',
      'api::movie.movie'
